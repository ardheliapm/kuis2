...
void main() {
  ...
  // ✅ JSON dengan field lengkap
  Map<String, dynamic> jsonData = {
    'id': 2,
    'name': 'Jane Doe',
    'email': 'jane@example.com',
    'created_at': '2024-01-01T10:00:00.000Z', // pakai created_at
  };

  // Debug: print struktur JSON
  ...
  print('created : ${jsonData['created_at']} (type: ${jsonData['created_at'].runtimeType})');

  // Coba parse JSON → User
  try {
  ...
  try {
    ...
    print('isValid: ${userFromIncomplete.isValid}');
  } catch (e) {
